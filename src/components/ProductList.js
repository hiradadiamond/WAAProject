  ...
  return (
    <div>
      ...
      <table>
        ...
        <tbody>
          {productList.filter(item=> item.productName.includes(searchKey)).map((product) => (
            <tr key={product.productNumber}>
              ...
              <td>
                <button value={product.productNumber} onClick={addToCart}>
                  Add to cart
                </button>
              </td>
              <td>
                <button value={product.productNumber} onClick={viewProductPage}>
                  View Product Page
                </button>
              </td>
            </tr>
      ...
      <button onClick={viewCart}>ViewShoppingCart</button>
    </div>
  );
};
